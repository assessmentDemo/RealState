package com.lap.assignment.retailsite;
...
import com.lap.assignment.retailsite.RetailSiteApplication;
import com.lap.assignment.retailsite.builder.BillBuilder;
import com.lap.assignment.retailsite.builder.RetailSiteBill;
import com.lap.assignment.retailsite.builder.UserBuilder;
import com.lap.assignment.retailsite.entity.Bill;
import com.lap.assignment.retailsite.entity.ShoppingItem;
import com.lap.assignment.retailsite.entity.ShoppingItemCategory;
import com.lap.assignment.retailsite.entity.UserType;
...
public class RetailSiteApplicationTests {
	...
	@Test
	// 30 % Discount
	public void employeeSegmentDicount() {

		retailSite.collectUserInfo(userBilder.firstName("Maheshwar").lastName("Prasad").telephone("9910487587")
	...
	@Test
	// 20 % Discount
	public void affelinateSegmentDicount() {
		retailSite.collectUserInfo(userBilder.firstName("Maheshwar").lastName("Prasad").telephone("9910487665")
	...
	@Test
	// 10% Discount
	public void oldCustomerSegmentDicount() {
		retailSite.collectUserInfo(userBilder.firstName("Maheshwar").lastName("Prasad").telephone("9910487665")
